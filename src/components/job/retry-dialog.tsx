...
// Magic Hour has no cancel API, so a retry is a brand-new submission of the same source and params,
// offered only once the original is truly done -- never while it might still finish and be charged
// for twice.
